<script>
  ...
  function handleKeydown(e) {
    fileName =
      saveLoad(e, html, markdownModel, styleModel, fileName) || fileName;
  }
...
<div class="container">
  <div class="container-left">
    ...
    <div class="style editor" class:active={activeTab === 'style'}>
      <Editor
        bind:model={styleModel}
        {...styleOptions}
        on:didContentChange={styleContentChange}
      />
    </div>
    <div class="markdown editor" class:active={activeTab === 'markdown'}>
      <Editor
        bind:model={markdownModel}
        {...markdownOptions}
        on:didContentChange={markdownContentChange}
      />
    </div>
